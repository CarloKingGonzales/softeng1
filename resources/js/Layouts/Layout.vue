...
<div class="w-64 bg-blue-500 h-screen">
    <div class="flex flex-col w-64 h-screen px-4 py-8 bg-white border-r dark:bg-gray-800 dark:border-gray-600">
        <h2 class="text-3xl font-semibold text-gray-800 dark:text-white">Gonzales, Carlo King R.</h2>
        ...
        <div class="flex flex-col justify-between flex-1 mt-6">
            ...
            <div class="flex items-center px-4 -mx-2">
                <img class="object-cover mx-2 rounded-full h-9 w-9" src="https://scontent.fcrk4-1.fna.fbcdn.net/v/t1.0-9/30411625_1834471423241210_4404292007732707328_o.jpg?_nc_cat=111&ccb=1-3&_nc_sid=09cbfe&_nc_eui2=AeGnp9Xw4kcgN9rfV32VjXkil7N7N8_4iCKXs3s3z_iIIjkjQaWN25Kd6T3fiKJ38Yh5Lx-S_KUUwLvG_IztnAiw&_nc_ohc=gW1PWlbfXksAX8gAFDI&_nc_ht=scontent.fcrk4-1.fna&oh=1ed4e5000b132e2ca926bffa7901b322&oe=60844AE7" alt="avatar">
                <h4 class="mx-2 font-medium text-gray-800 dark:text-gray-200 hover:underline">John Doe</h4>
            </div>
        </div>
    </div></div>
<div class="w-full bg-green-500 h-screen flex flex-col">
